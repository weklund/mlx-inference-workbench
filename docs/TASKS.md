...
- [x] Thermal-protocol baseline → [#36](https://github.com/weklund/mlx-inference-workbench/issues/36) (`e46a28d62dee`; warmup 10 in config; correctness off until dataset refs)
...
> Thermal-protocol performance baseline: **done** → [#36](https://github.com/weklund/mlx-inference-workbench/issues/36) / run `e46a28d62dee` (full HLD correctness still needs dataset references).
...
- [x] Thermal-protocol baseline under closed methodology → [#36](https://github.com/weklund/mlx-inference-workbench/issues/36) (`e46a28d62dee`, thermal `full`; correctness deferred)
